...
class _SeatItemWidgetState extends State<SeatItemWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    return showSeat(_seat, _seat.state);
  }

  showSeat(SeatModel seat, SeatState state) {
    if (state == SeatState.pass) {
    ...
    } else if (selectedSeat.contains(seat) && selectedSeat.length <= limit) {
