...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Planet> planetList =
      PlanetResponse.fromJson(jsonDecode(jsonPlanets)).results;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Container(
            child: Image.network('https://sm.mashable.com/mashable_in/photo/default/nasa-galaxy_9pu4.jpg', fit: BoxFit.fitHeight, height: MediaQuery.of(context).size.height,)
          ),
          Column(
                              ...
                              child: Card(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(planetList.elementAt(index).name, style: Styles.textName,)
                                    ],
                                  )),
                            ),
                          );
